...
import com.CloudShare.entity.vo.UserInfoVO;
...
public class AdminController extends CommonFileController {
    ...
    public ResponseVO saveSysSettings(
            ...
            @VerifyParam(required = true) String cityCode) {
        ...
        sysSettingsDto.setCityCode(cityCode);
    ...
    public ResponseVO loadUser(UserInfoQuery userInfoQuery) {
        ...
        PageInfoResultVO resultVO = userInfoService.findListByPage(userInfoQuery);
    ...
    public ResponseVO loadDataList(FileInfoQuery query) {
        ...
        PageInfoResultVO resultVO = fileInfoService.findListByPage(query);
