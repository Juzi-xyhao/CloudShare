...
import com.CloudShare.entity.enums.ShareValidTypeEnums;
...
import com.CloudShare.mappers.FileShareMapper;
...
public class FileShareServiceImpl implements FileShareService {
     ...
     */
    @Override
    public PageInfoResultVO<FileShare> findListByPage(FileShareQuery param) {
        ...
        PageInfoResultVO<FileShare> result = new PageInfoResultVO(count, page.getPageSize(), page.getPageNo(), page.getPageTotal(), list);
        return result;
    }
